...
n(c);return!0};c.trackView=function(){B(function(){var a=p("pageView");a.event_type=d.event_type;f("tvunna.trackView");n(a)})};c.trackClicks=function(){u("click","a, button, input[type=submit], img",function(a){a=a.target;var b=p("click");b.event_type=d.event_type;b.tag=g(a.tagName.toLowerCase());"img"==b.tag?(b.href=g(a.parentNode.href),b.properties=a.parentNode.dataset):(b.href=g(a.href),b.properties=a.dataset);b.id=g(a.id);b.text=g("input"==b.tag?a.value:(a.textContent||a.innerText||a.innerHTML).replace(/[\s\r\n]+/g,
" ").trim());b.class_name=g(a.className);b.section=t(a);f("tvunna.trackClicks");n(b)})};c.trackSubmits=function(){u("submit","form",function(a){a=a.target;var b=p("submit");b.event_type=d.event_type;b.href=g(a.href);b.tag=g(a.tagName.toLowerCase());b.id=g(a.id);b.class_name=g(a.className);b.section=t(a);f("tvunna.trackSubmits");n(b)})};c.trackChanges=function(){u("change","input, textarea, select",function(a){a=a.target;var b=p("change");b.event_type=d.event_type;b.href=g(a.href);b.tag=g(a.tagName.toLowerCase());
b.id=g(a.id);b.text=g("input"==b.tag?a.value:(a.textContent||a.innerText||a.innerHTML).replace(/[\s\r\n]+/g," ").trim());b.class_name=g(a.className);b.section=t(a);f("tvunna.trackChanges");n(b)})};c.trackAll=function(){c.trackView();c.trackClicks();c.trackSubmits();c.trackChanges()};return c});
