...
e("connecting to: "+d.host+":"+d.port+", clientId: "+a);m=new Paho.MQTT.Client(d.host,d.port,a);d.listenTopicOut&&(m.onMessageArrived=onMessageArrived);m.onConnectionLost=B;m.connect(b)};for(var g=[],r=0;256>r;r++)g[r]=(16>r?"0":"")+r.toString(16);b.track=function(a,b){var c=q(a,b);e("tvunna.track");p(c);return!0};b.trackView=function(){C(function(){var a=q("pageViewJS");e("tvunna.trackView");p(a)})};b.trackClicks=function(){u("click","a, button, input[type=submit], img",function(a){a=a.target;var b=
q("clickJS"),c=b.captured_data_payload;c.tag=h(a.tagName.toLowerCase());"img"==c.tag?(c.href=h(a.parentNode.href),c.dataset=a.parentNode.dataset):(c.href=h(a.href),c.dataset=a.dataset);c.id=h(a.id);c.class_name=h(a.className);c.text=h("input"==c.tag?a.value:(a.textContent||a.innerText||a.innerHTML).replace(/[\s\r\n]+/g," ").trim());v(b,c);e("tvunna.trackClicks");p(b)})};b.trackSubmits=function(){u("submit","form",function(a){a=a.target;var b=q("submitJS"),c=b.captured_data_payload;c.tag=h(a.tagName.toLowerCase());
c.href=h(a.href);c.dataset=a.dataset;c.id=h(a.id);c.class_name=h(a.className);v(b,c);e("tvunna.trackSubmits");p(b)})};b.trackChanges=function(){u("change","input, textarea, select",function(a){a=a.target;var b=q("changeJS"),c=b.captured_data_payload;c.tag=h(a.tagName.toLowerCase());c.href=h(a.href);c.dataset=a.dataset;c.id=h(a.id);c.class_name=h(a.className);c.text=h(a.value);v(b,c);e("tvunna.trackChanges");p(b)})};b.trackAll=function(){b.trackView();b.trackClicks();b.trackSubmits();b.trackChanges()};
b.reset=function(){b.destroyCookie("tvunna_visit");b.destroyCookie("tvunna_visitor");return!0};b.debug=function(a){!1===a?b.destroyCookie("tvunna_debug"):b.setCookie("tvunna_debug","t",525600);x=b.getCookie("tvunna_debug");return!0};return b});
